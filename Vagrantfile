...
public_folder         = "/var/www/public" # If installing Symfony or Laravel, leave this blank to default to the framework public directory
...
Vagrant.configure("2") do |config|
  ...
  config.vm.synced_folder "/Users/NANDES/Documents/www", "/var/www",
            id: "core",
            :nfs => true,
